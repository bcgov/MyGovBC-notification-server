...
* If you think you've found a bug within Jekyll itself, [open an issue](https://github.com/bcgov/MyGovBC-notification-server/issues/new).
...
* [Install Jekyll on your computer](https://jekyllrb.com/docs/installation/) and kick the tires. Does it work? Does it do what you'd expect? If not, [open an issue](https://github.com/bcgov/MyGovBC-notification-server/issues/new) and let us know.
* Comment on some of the project's [open issues](https://github.com/bcgov/MyGovBC-notification-server/issues). Have you experienced the same problem? Know a work around? Do you have a suggestion for how the feature could be better?
* Read through [the documentation](https://jekyllrb.com/docs/home/), and click the "improve this page" button, any time you see something confusing, or have a suggestion for something that could be improved.
* Browse through [the Jekyll discussion forum](https://talk.jekyllrb.com/), and lend a hand answering questions. There's a good chance you've already experienced what another user is experiencing.
* Find [an open issue](https://github.com/bcgov/MyGovBC-notification-server/issues) (especially [those labeled `help-wanted`](https://github.com/bcgov/MyGovBC-notification-server/issues?q=is%3Aopen+is%3Aissue+label%3Ahelp-wanted)), and submit a proposed fix. If it's your first pull request, we promise we won't bite, and are glad to answer any questions.
* Help evaluate [open pull requests](https://github.com/bcgov/MyGovBC-notification-server/pulls), by testing the changes locally and reviewing what's proposed.
...
1. Navigate to the file within [`bcgov/MyGovBC-notification-server`](https://github.com/bcgov/MyGovBC-notification-server) that you'd like to edit.
...
1. Fork the project by clicking "Fork" in the top right corner of [`bcgov/MyGovBC-notification-server`](https://github.com/bcgov/MyGovBC-notification-server).
...
You can find the documentation for jekyllrb.com in the [site](https://github.com/bcgov/MyGovBC-notification-server/tree/master/site) directory. See the section above, [submitting a pull request](#submitting-a-pull-request) for information on how to propose a change.

One gotcha, all pull requests should be directed at the `master` branch (the default branch).

### Adding plugins

If you want to add your plugin to the [list of plugins](https://jekyllrb.com/docs/plugins/#available-plugins), please submit a pull request modifying the [plugins page source file](https://github.com/bcgov/MyGovBC-notification-server/blob/master/site/_docs/plugins.md) by adding a link to your plugin under the proper subheading depending upon its type.
