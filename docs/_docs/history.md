...
- Omit bcgov/MyGovBC-notification-server-help from list of resources. ([#3698]({{ site.repository }}/issues/3698))
...
- Update JRuby testing to 9K ([3ab386f](https://github.com/bcgov/MyGovBC-notification-server/commit/3ab386f1b096be25a24fe038fc70fd0fb08d545d))
...
- Move to bcgov/MyGovBC-notification-server from mojombo/jekyll ([#1817]({{ site.repository }}/issues/1817))
