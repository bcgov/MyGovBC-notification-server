  ...
  "acknowledgements":{
    ...
    "notification":{
      "email": {
        ...
        "textBody": "This is to acknowledge you have been un-subscribed from receiving notification for service {service_name}. If you did not authorize this change or if you changed your mind, click {http_host}{rest_api_root}/subscriptions/{subscription_id}/unsubscribe/undo?unsubscriptionCode={unsubscriptionCode} to revert."
      }
    }
  }
}
