module.exports = function (app, cb) {
  ...
  app.models.Configuration.findOrCreate({where: {name: 'dbSchemaVersion'}}, {
    name: "dbSchemaVersion",
    value: "0.0.0"
  }, function (err, data) {
    const currentVersion = data.value
    if (semver.major(targetVersion) === semver.major(currentVersion) && semver.minor(targetVersion) > semver.minor(currentVersion)) {
